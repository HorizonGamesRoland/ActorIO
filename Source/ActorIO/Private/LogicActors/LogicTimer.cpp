...
void ALogicTimer::RegisterIOEvents_Implementation(TArray<FActorIOEvent>& RegisteredEvents)
{
...
void ALogicTimer::RegisterIOFunctions_Implementation(TArray<FActorIOFunction>& RegisteredFunctions)
{
